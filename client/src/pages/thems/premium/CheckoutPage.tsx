...
export default function CheckoutPage() {
  ...
  return (
    <div className="premium-route premium-route-checkout space-y-7">
      <section className="storefront-panel premium-hero relative overflow-hidden p-6">
        ...
        <div className="relative">
          <span className="storefront-kicker">Concierge Checkout</span>
          <h1 className="storefront-heading mt-2 text-3xl font-semibold text-slate-900">Finalize Your Maison Order</h1>
