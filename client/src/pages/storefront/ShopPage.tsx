...
export default function ShopPage() {
  ...
  return (
    <div className="space-y-7">
      <section className="storefront-panel relative overflow-hidden p-6 sm:p-7">
        ...
        <div className="relative flex flex-wrap items-end justify-between gap-3">
          <div className="space-y-2">
            <span className="storefront-kicker">Curated Catalog</span>
            <h1 className="storefront-heading text-3xl font-semibold text-slate-900 sm:text-4xl">Shop Products</h1>
