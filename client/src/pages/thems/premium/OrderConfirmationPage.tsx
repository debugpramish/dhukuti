...
export default function OrderConfirmationPage() {
  ...
  return (
    <div className="premium-route premium-route-order space-y-7">
      <section className="storefront-panel rounded-2xl border-emerald-200 bg-emerald-50/90 p-6">
        <div className="flex flex-wrap items-center gap-3">
          <CheckCircle2 className="h-7 w-7 text-emerald-600" />
          <div>
            <h1 className="storefront-heading text-3xl font-semibold text-emerald-900">Order Confirmed In Maison</h1>
