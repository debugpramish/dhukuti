...
export default function ContactPage() {
  ...
  return (
    <div className="premium-route premium-route-contact space-y-6">
      <section className="premium-hero rounded-3xl border border-slate-200/60 bg-gradient-to-r from-slate-950 via-slate-900 to-cyan-900 p-6 text-white shadow-[0_26px_60px_-36px_rgba(2,6,23,0.98)] sm:p-8">
        <h1 className="storefront-heading text-4xl font-semibold">Maison Concierge</h1>
        <p className="mt-2 max-w-2xl text-sm text-slate-200">
          Have questions about products, delivery, or your order? Send a message for priority support from the store team.
        </p>
      </section>
