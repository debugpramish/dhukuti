  ...
  if (wishlistItems.length === 0) {
    return (
      <div className="storefront-panel p-10 text-center">
        <h1 className="storefront-heading text-3xl font-semibold text-slate-900">Wishlist is empty</h1>
  ...
  return (
    <div className="space-y-7">
      <section className="storefront-panel p-6">
        <span className="storefront-kicker">Saved Items</span>
        <h1 className="storefront-heading mt-2 text-3xl font-semibold text-slate-900">Wishlist</h1>
      </section>
