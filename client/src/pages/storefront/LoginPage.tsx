...
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto grid w-full max-w-4xl gap-6 lg:grid-cols-[0.9fr_1fr]">
      <aside className="storefront-panel relative hidden overflow-hidden p-6 lg:block">
        ...
        <div className="relative space-y-3">
          <span className="storefront-kicker">Welcome Back</span>
          <h2 className="storefront-heading text-3xl font-semibold text-slate-900">Your account, your orders.</h2>
      ...
      <section className="storefront-panel p-6">
        <h1 className="storefront-heading text-3xl font-semibold text-slate-900">Customer Login</h1>
        <p className="mt-1 text-sm text-slate-600">Sign in to place orders and track deliveries.</p>
