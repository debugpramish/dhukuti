...
export default function RegisterPage() {
  ...
  return (
    <div className="premium-route premium-route-auth mx-auto w-full max-w-2xl">
      <section className="storefront-panel p-6">
        <h1 className="storefront-heading text-3xl font-semibold text-slate-900">Create Maison Account</h1>
        <p className="mt-1 text-sm text-slate-600">Join for premium checkout, saved selections, and order history.</p>
